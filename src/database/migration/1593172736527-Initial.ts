...
export class Initial1593172736527 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`CREATE TABLE "temporary_game" ("id" varchar PRIMARY KEY NOT NULL, "parentGameId" varchar, "title" varchar COLLATE NOCASE NOT NULL, "series" varchar COLLATE NOCASE NOT NULL, "developer" varchar COLLATE NOCASE NOT NULL, "dateAdded" datetime NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "platform" varchar COLLATE NOCASE NOT NULL, "broken" boolean NOT NULL, "extreme" boolean NOT NULL, "levelType" varchar COLLATE NOCASE NOT NULL, "status" varchar COLLATE NOCASE NOT NULL, "notes" varchar COLLATE NOCASE NOT NULL, "source" varchar COLLATE NOCASE NOT NULL, "applicationPath" varchar NOT NULL, "launchCommand" varchar NOT NULL, "releaseDate" varchar COLLATE NOCASE NOT NULL, "version" varchar COLLATE NOCASE NOT NULL, "originalDescription" varchar COLLATE NOCASE NOT NULL, "language" varchar COLLATE NOCASE NOT NULL, "library" varchar COLLATE NOCASE NOT NULL, "orderTitle" varchar COLLATE NOCASE NOT NULL, CONSTRAINT "FK_45a9180069d42ac8231ff11acd0" FOREIGN KEY ("parentGameId") REFERENCES "game" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
		await queryRunner.query(`INSERT INTO "temporary_game"("id", "parentGameId", "title", "series", "developer", "dateAdded", "dateModified", "platform", "broken", "extreme", "levelType", "status", "notes", "source", "applicationPath", "launchCommand", "releaseDate", "version", "originalDescription", "language", "library", "orderTitle") SELECT "id", "parentGameId", "title", "series", "developer", "dateAdded", "dateModified", "platform", "broken", "extreme", "levelType", "status", "notes", "source", "applicationPath", "launchCommand", "releaseDate", "version", "originalDescription", "language", "library", "orderTitle" FROM "game"`, undefined);
	...
	public async down(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`CREATE TABLE "game" ("id" varchar PRIMARY KEY NOT NULL, "parentGameId" varchar, "title" varchar COLLATE NOCASE NOT NULL, "series" varchar COLLATE NOCASE NOT NULL, "developer" varchar COLLATE NOCASE NOT NULL, "dateAdded" datetime NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "platform" varchar COLLATE NOCASE NOT NULL, "broken" boolean NOT NULL, "extreme" boolean NOT NULL, "levelType" varchar COLLATE NOCASE NOT NULL, "status" varchar COLLATE NOCASE NOT NULL, "notes" varchar COLLATE NOCASE NOT NULL, "source" varchar COLLATE NOCASE NOT NULL, "applicationPath" varchar NOT NULL, "launchCommand" varchar NOT NULL, "releaseDate" varchar COLLATE NOCASE NOT NULL, "version" varchar COLLATE NOCASE NOT NULL, "originalDescription" varchar COLLATE NOCASE NOT NULL, "language" varchar COLLATE NOCASE NOT NULL, "library" varchar COLLATE NOCASE NOT NULL, "orderTitle" varchar COLLATE NOCASE NOT NULL)`, undefined);
		await queryRunner.query(`INSERT INTO "game"("id", "parentGameId", "title", "series", "developer", "dateAdded", "dateModified", "platform", "broken", "extreme", "levelType", "status", "notes", "source", "applicationPath", "launchCommand", "releaseDate", "version", "originalDescription", "language", "library", "orderTitle") SELECT "id", "parentGameId", "title", "series", "developer", "dateAdded", "dateModified", "platform", "broken", "extreme", "levelType", "status", "notes", "source", "applicationPath", "launchCommand", "releaseDate", "version", "originalDescription", "language", "library", "orderTitle" FROM "temporary_game"`, undefined);
